        ...
        model_exporter.init(sess.graph.as_graph_def(),
                            named_graph_signatures={
                                'inputs': exporter.generic_signature({
                                    'question_lengths': valid_graph.question_lengths,
                                    'passage_lengths': valid_graph.passage_lengths,
                                    'in_question_words': valid_graph.in_question_words,
                                    'in_passage_words': valid_graph.in_passage_words,
                                    'question_char_lengths': valid_graph.question_char_lengths,
                                    'passage_char_lengths': valid_graph.passage_char_lengths,
                                    'in_question_chars': valid_graph.in_question_chars,
                                    'in_passage_chars': valid_graph.in_passage_chars,
                                }),
                                'outputs': exporter.generic_signature({
                                    'prob': valid_graph.prob,
                                })
                            })

        print("export model ...")
        OUTPUT_MODEL_DIR = "/home/tong.guo/cpp_model_BiMPM"
